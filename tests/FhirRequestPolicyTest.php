 ...
 * directly with no fakes at all - ported one-for-one (module namespace
 * only) from redcap_fhir_ontology_provider, which received this circuit
 * breaker / origin-scoping hardening in an earlier security audit that
 * this sibling module never got.
 */
